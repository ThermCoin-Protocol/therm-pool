...
### <Link href="/docs/network">1. ThermCoin Network 🌐</Link>
Delve into the core of the ThermCoin Network. 

### <Link href="/docs/token">2. ThermCoin Token 🪙</Link>
Explore the primary token of the network, BTUC.

### <Link href="/docs/pool">3. ThermCoin Mining Pool ⛏️</Link>
Gain insights into the ThermCoin Mining Pool.

### <Link href="/docs/how-to">4. How to Mine ThermCoin 💻 </Link>
